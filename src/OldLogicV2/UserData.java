...
public class UserData implements Serializable {
    ...
    public String getMp() {
        ...
        for (int i = 0; i < Memory.mpr; i++) {
            mp_temp = Base64Encode.Decode_Base64(mp_temp);
        }
        return mp_temp;
    }
    ...
    public void setMp(String mp) {
        String mp_temp = mp;
        for (int i = 0; i < Memory.mpr; i++) {
            mp_temp = Base64Encode.Encode_Base64(mp_temp);
        }
        this.mp = mp_temp;
    }
    ...
    public String getMpa() {
        ...
        for (int i = 0; i < Memory.mpr; i++) {
            mpa_temp = Base64Encode.Decode_Base64(mpa_temp);
        }
        return mpa_temp;
    }
    ...
    public void setMpa(String mpa) {
        String mpa_temp = mpa;
        for (int i = 0; i < Memory.mpr; i++) {
            mpa_temp = Base64Encode.Encode_Base64(mpa_temp);
        }
        this.mpa = mpa_temp;
    }
    ...
    public String getMpa_original() {
        ...
        for (int i = 0; i < Memory.mpr; i++) {
            mpa_o_temp = Base64Encode.Decode_Base64(mpa_o_temp);
        }
        return mpa_o_temp;
    }
